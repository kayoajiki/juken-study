...
import { schedules, users, dailyGoalHistory } from "@/db/schema";
...
export default async function SchedulePage() {
  ...
  const [rows, urow, memoRows, goalRows] = await Promise.all([
    ...
    db
      .select({ effectiveDate: dailyGoalHistory.effectiveDate, minutes: dailyGoalHistory.minutes })
